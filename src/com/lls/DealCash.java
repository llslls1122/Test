...
public class DealCash {
  ...
  public void setUp() throws Exception {
    ...
    baseUrl = "http://172.16.1.85";
    //http://172.16.1.85/h5/Dashboard/user/login.html?flow=loginRedirect
    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  }

  @org.junit.Test
  public void testDealCash() throws Exception {
