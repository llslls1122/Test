...
//    driver.findElement(By.id("clientSecret")).sendKeys(Keys.ENTER);
    ...
    driver.findElement(By.xpath("/html/body/ul/li[2]/a/div[1]/span")).click();
...
//   new TouchActions(driver).singleTap(confirm).perform();
   ...
   new TouchActions(driver).singleTap(password1).perform();
   new TouchActions(driver).singleTap(password1).perform();
   ////*[@id="custom-keyboard"]/div[1]
//   WebElement password = driver.findElement(By.xpath("//*[@id='J_login_form']/dl/dt/input[@id='J_password']"));


//   WebElement password = driver.findElement(By.cssSelector("#custom-keyboard>div[keyvalue='1']"));
   ////*[@id="custom-keyboard"]/div[1]  //*[@id="custom-keyboard"]/div[1]
//   password.click();
//   testNewWindow();
   thread.stop();
//   thread.;
   /*pas.sendKeys(Keys.NUMPAD1);
   pas.sendKeys(Keys.NUMPAD1);
   pas.sendKeys(Keys.NUMPAD1);
   pas.sendKeys(Keys.NUMPAD1);
   pas.sendKeys(Keys.NUMPAD1);
...
//   new TouchActions(driver).up(x, y).perform();
  ...
  /* new TouchActions(driver).singleTap(confirm).perform();
   new TouchActions(driver).doubleTap(confirm).perform();*/
//   new TouchActions(driver).singleTap(confirm).perform();
//   new TouchActions(driver).click(confirm).perform();
  }
